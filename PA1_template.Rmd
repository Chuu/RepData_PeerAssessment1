...
pa1.WeekendSteps <- aggregate(steps~interval,
                              pa1.DataFilled[which(!(pa1.DataFilled$IsWeekday)), ], mean);
par(mfrow=c(2,1), mar=c(5,5,2,0));
plot(pa1.WeekdaySteps$interval, pa1.WeekdaySteps$steps, type="l", 
     main="Weekday Steps per Interval", xlab="Interval", ylab="Steps", ylim=c(0,250))
plot(pa1.WeekendSteps$interval, pa1.WeekendSteps$steps, type="l", 
     main = "Weekend Steps per Interval", xlab="Interval", ylab="Steps", ylim=c(0,250))
```
